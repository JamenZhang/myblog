...
//        在redis中保存手机号验证码并设置过期时间
        ...
        String msgCode = "SMS_171115004";
        //注册的短信模板
        if(REGISTER.equals(sign)){
            msgCode = "SMS_171115004";
        }
        //改密码的短信模板
        else {
            msgCode = "SMS_171115009";
        }
    ...
    public static SendSmsResponse sendSmsResponse(String phoneNumber, String code, String msgCode) throws ClientException {
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAIRYtxEY4jEAvi", "OENaMmWErfiaBJhS99lDAEypzSKvDt");
